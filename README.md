...
This is the biggest benefit I've taken from serverside rendering, turning off the javascript still lets all my fetches work.<br><br>
You can also use attributes like defer and async on html script tags, this will make sure that the rendering of the page will not be blocked by these scripts.
</details>
