...
I have also minified my styles.css, this removes all the unnecessary spaces and comments in the css file, which decreases the file size and the time to execute the css.
<br><br>
